      ...
      <div className="w-full max-w-md bg-white rounded-lg shadow-lg p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-4" noValidate>
          ...
          <input
            ...
            className={`w-full px-4 py-2 border rounded-lg focus:ring-2 ${emailError ? "border-red-500 focus:ring-red-300" : "focus:ring-green-300"
              }`}
            required
          />
          {emailError && (
          ...
          <input
            ...
            className={`w-full px-4 py-2 border rounded-lg focus:ring-2 ${passwordError ? "border-red-500 focus:ring-red-300" : "focus:ring-green-300"
              }`}
            required
          />
          {passwordError && (
          ...
          <button
            type="submit"
            className={`w-full text-white font-semibold py-2 rounded-lg transition ${isSubmitDisabled ? "bg-green-300 cursor-not-allowed" : "bg-green-500 hover:bg-green-600"
              }`}
