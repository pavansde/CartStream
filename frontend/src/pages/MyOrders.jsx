              ...
              >
                ...
                <div className="px-6 py-4 border-b border-gray-100 bg-gradient-to-r from-gray-50 to-white">
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    ...
                    <span
                      className={`px-4 py-2 rounded-full text-sm font-semibold capitalize ${order.status === "Delivered"
                ...
                <div className="p-6">
                  ...
                  <div className="mt-6 space-y-3">
                    ...
                    <button
                      className={`group relative w-full px-4 py-3 rounded-lg font-semibold text-base transition-all duration-200 transform hover:scale-[1.01] ${reordering
