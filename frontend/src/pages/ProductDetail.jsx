...
//     if (!selectedVariant) {
//       return item?.image_url ? [`http://10.118.241.149:8000${item.image_url}`] : [];
//     }

//     if (selectedVariant.image_url) {
//       return [`http://10.118.241.149:8000${selectedVariant.image_url}`];
//     }
...
//             <li>›</li>
//             <li><Link to="/" className="hover:text-gray-700">Products</Link></li>
//             <li>›</li>
//             <li><span className="text-gray-700 font-medium">{item.title}</span></li>
//           </ol>
//         </nav>
...
//                     className="p-2 rounded-full border border-gray-200 hover:border-red-200 text-gray-400 hover:text-red-500 transition-colors"
...
//                         className={`px-3 py-2 border-2 rounded-lg capitalize ${
...
//                   className={`flex-1 px-8 py-3 border border-transparent text-base font-medium rounded-lg text-white transition-all ${
//                     currentStock === 0
...
//                   className={`flex-1 px-8 py-3 border border-transparent text-base font-medium rounded-lg transition-all ${
//                     currentStock === 0
...
function ProductDetail() {
  ...
  const getCurrentImages = () => {
    ...
    if (selectedVariant.images && Array.isArray(selectedVariant.images) && selectedVariant.images.length > 0) {
      return selectedVariant.images.map(img => `http://10.118.241.149:8000${img}`);
    }
            ...
            <div className="space-y-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {availableColors.map((variant) => (
                      <button
                        key={variant.color}
                        onClick={() => handleVariantSelect(variant)}
                        className={`flex items-center space-x-2 px-3 py-2 border-2 rounded-lg transition-all ${
                          selectedVariant?.color === variant.color
              ...
              <div className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-4 pt-4">
                <button
                  disabled={currentStock === 0 || addingToCart}
                  onClick={handleAddToCart}
                  className={`flex-1 flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-lg text-white transition-all ${
                    currentStock === 0
                      ? "bg-gray-400 cursor-not-allowed"
